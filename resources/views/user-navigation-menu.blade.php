<nav x-data="{ open: false }" class="bg-gradient-to-r from-gray-400">
                ...
                <div class="flex">
                    ...
                    <!-- Logo -->
                        <a href="{{ route('admin.dashboard') }}">
                            <h1 class="font-bold text-black md:text-4xl"><span class="text-red-500">GARRY'S MOD</span> INDONESIA</h1>
                        </a>
                    </div>
                </div>
...
<div class="flex min-w-full ">
    <aside class="md:flex flex-col md:flex-row md:h-screen absolute">
            <div @click.away="open = false" class="flex flex-col w-full md:w-40 text-gray-700 bg-gray-200 flex-shrink-0" x-data="{ open: false }">
                ...
                <nav :class="{'block': open, 'hidden': !open}" class="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto">
                    <x-jet-nav-link class="block px-4 py-2 mt-2 text-sm font-semibold text-gray-700 bg-transparent rounded-lg hover:text-gray-300 focus:text-gray-300 hover:bg-gray-500 focus:bg-gray-600 focus:outline-none focus:shadow-outline" href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">Dashboard</x-jet-nav-link><br />
                    <x-jet-nav-link class="block px-4 py-2 mt-2 text-sm font-semibold text-gray-700 bg-transparent rounded-lg hover:text-gray-300 focus:text-gray-300 hover:bg-gray-500 focus:bg-gray-600 focus:outline-none focus:shadow-outline" href="{{ route('admin.galleries') }}" :active="request()->routeIs('admin.galleries')">Donation</x-jet-nav-link><br />
                </nav>
            </div>
    </aside>