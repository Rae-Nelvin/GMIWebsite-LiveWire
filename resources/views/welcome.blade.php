        ...
        <nav class="navbar navbar-fixed-top navbar-expand-lg navbar-dark pt-4" style="margin-left: 7%;">
            <div class="container">
                <div class="row container-fluid">
                    <div class="col-2"><a href="{{ route('index') }}"><img src="{{ asset('assets/images/gmilogo/gmi_logo_old.png') }}" alt="GMI Logo" id="navbar-logo"></a></div>
                    <div class="col-6"></div>
                    <div class="col-4"><a href="#admin"><button class="btn btn-outline-light rounded-pill my-sm-0" type="submit" id="btn-contact-us">Donate</button></a></div>
                </div>
            </div>
        </nav>
